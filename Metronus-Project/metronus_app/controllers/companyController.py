...
def create(request):
    ...
    return render_to_response('company_register.html', {'form': form, }, context_instance=RequestContext(request))
...
def registerAdministrator(form, company):
    ...
    admin = User.objects.create_user(username=username, password=password, email=email, first_name=first_name, last_name=last_name)
